    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="languageDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="flag-icon flag-icon-es mt-1" title="es"></i> <span class="font-weight-medium ml-1 mr-1">Español</span>
        </a>
        ...
        <div class="dropdown-menu" aria-labelledby="appsDropdown">
          ...
          <div class="dropdown-body">
            <div class="d-flex align-items-center apps">
              ...
              <a href="{{ url('/apps/calendar') }}"><i data-feather="calendar" class="icon-lg"></i><p>Calendario</p></a>
              <a href="{{ url('/email/inbox') }}"><i data-feather="mail" class="icon-lg"></i><p>Email</p></a>
              <a href="{{ url('/general/profile') }}"><i data-feather="instagram" class="icon-lg"></i><p>Perfil</p></a>
            </div>
          </div>
      ...
      <li class="nav-item dropdown nav-messages">
        ...
        <div class="dropdown-menu" aria-labelledby="messageDropdown">
          <div class="dropdown-header d-flex align-items-center justify-content-between">
            <p class="mb-0 font-weight-medium">Mensajes nuevos</p>
            <a href="javascript:;" class="text-muted">Borrar todo</a>
          </div>
          <div class="dropdown-body">
        ...
        <div class="dropdown-menu" aria-labelledby="profileDropdown">
          <div class="dropdown-header d-flex flex-column align-items-center">
            ...
            <div class="info text-center">
              <p class="name font-weight-bold mb-0">Yuqing Lin</p>
              <p class="email text-muted mb-3">fabriciolin70@gmail.com</p>
            </div>
          </div>
          <div class="dropdown-body">
