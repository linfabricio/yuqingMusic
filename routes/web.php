...
Route::group(['prefix' => 'apps'], function(){
    ...
    Route::get('music', function () { return view('pages.apps.music'); });
    Route::get('album/new', function () { return view('pages.apps.albumNew'); });
    Route::get('album', function () { return view('pages.apps.album'); });
    Route::get('artist', function () { return view('pages.apps.artist'); });
});
